defmodule SimpleWrtcDemo.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      # {SimpleWrtcDemo.Worker, arg}
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: SimpleWrtcDemo.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    SimpleWrtcDemoWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
